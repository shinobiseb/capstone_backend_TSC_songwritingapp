...
mongoose.connection
    .on("open", function () { return console.log("Connected to Mongo"); })
    .on("close", function () { return console.log("disconnected from mongo"); })
    .on("error", function (error) { return console.error; });
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _c.trys.push([0, 2, , 3]);
                _b = (_a = res).json;
                return [4, Note.findByIdAndUpdate(req.params.id, req.body, { new: true })];
            case 1:
                _b.apply(_a, [_c.sent()]);
                return [3, 3];
            case 2:
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _c.trys.push([0, 2, , 3]);
                _b = (_a = res).json;
                return [4, Note.findByIdAndRemove(req.params.id)];
            case 1:
                _b.apply(_a, [_c.sent()]);
                return [3, 3];
            case 2:
